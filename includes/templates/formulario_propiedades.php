<fieldset>
                ...
                <textarea id="descripcion" name="descripcion" value="<?php echo s($descripcion); ?>"> <?php echo s($descripcion); ?> </textarea>
            </fieldset>
            ...
            <fieldset>
                ...
                <input type="number" id="wc" name="wc" placeholder="Ej. 1" min="1" max="9" value="<?php echo s($wc); ?>">
